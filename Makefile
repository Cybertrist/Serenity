...
.PHONY: help init keys up down restart logs ps client reset-totp watch-now schedule-now test lint vectors web-test crypto-interop e2e ui-smoke rotation-demo api-doc dev-image
