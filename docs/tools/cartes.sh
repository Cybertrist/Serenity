#!/bin/bash
# The banner template, shared with the author's other projects so every
# repository opens on the same card: logo plate, title, two lines, pills,
# and the category in the top right corner.
